...
**Changes:**
- Re-enabled ARM64 cross-compilation builds for all platforms
- Linux aarch64 via cross
- macOS aarch64 native on macos-14
- Windows aarch64 via MSVC cross-compile

**Files Modified:**
- `.github/workflows/ci-release.yml` - Uncommented ARM64 jobs, restored release dependencies
...
**Locations:**
- `.github/workflows/ci-release.yml:79` - linux-arm64 job
- `.github/workflows/ci-release.yml:108` - macos-arm64 job
- `.github/workflows/ci-release.yml:134` - windows-arm64 job
- `.github/workflows/ci-release.yml:169` - release needs array
