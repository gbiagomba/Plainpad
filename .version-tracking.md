...
### v0.2.5 (2026-01-31)
**Type:** CI Adjustment (PATCH)  \
**Branch:** main  \
**Tag:** v0.2.5

**Changes:**
- Commented out ARM64 cross-build jobs temporarily

**Files Modified:**
- `.github/workflows/ci-release.yml` - ARM64 job blocks commented
...
**Locations:**
- `.github/workflows/ci-release.yml:79` - ARM64 job blocks commented
- `.github/workflows/ci-release.yml:166` - Removed ARM64 jobs from release dependencies
...
### v0.2.4 (2026-01-31)
**Type:** CI Update (PATCH)  \
**Branch:** main  \
**Tag:** v0.2.4

**Changes:**
- Switched macOS CI runner to `macos-latest`

**Files Modified:**
- `.github/workflows/ci-release.yml` - Runner matrix update
- `Cargo.toml` - Version bump
- `README.md` - Version bump
- `CHANGELOG.md` - Patch release notes
- `.version-tracking.md` - Tracking entry
...
**Locations:**
- `.github/workflows/ci-release.yml:25` - Runner matrix update
